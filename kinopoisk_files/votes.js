...
*/
        ...
        $(dom_ids.eye_id)
            ...
            .click(function(){
                ...
                $.get('/handler_vote.php', {id_film: id_film, "c": KP.Stars.codes[id_film], act: ($(this).hasClass('eye_act') ? 'delete' : 'add'), rnd: now.getTime()}, function(data) {
                    ...
                    if (data == 'ok') {
                        ...
                        if ($(dom_ids.eye_id).hasClass('eye_act')) {
                            $.app.authorityAction();
                        }
